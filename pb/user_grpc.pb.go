...
func (x *userServiceAddUserVerboseClient) Recv() (*UserResponse, error) {
	m := new(UserResponse)
...
func (x *userServiceAddUsersBothStreamClient) Recv() (*UserResponse, error) {
	m := new(UserResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *userServiceAddUserVerboseServer) Send(m *UserResponse) error {
...
func (x *userServiceAddUsersBothStreamServer) Send(m *UserResponse) error {
	return x.ServerStream.SendMsg(m)
}
